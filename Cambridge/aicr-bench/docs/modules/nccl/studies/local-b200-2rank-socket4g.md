...
- Scope: Focus rows: `b200_2rank_socket_4g` from the shared B200 local suite bundle.
...
### NCCL B200 local two rank socket policy Dashboard
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | --- | --- |
| `b0003` | `1n` | `223453Z-r01` | `small` | `b200_2rank_socket_4g` | `allreduce` | `rank0=3,0,1,2;rank1=7,4,5,6` | `2rank_socket_4g` | 2 | 4 | `passed` | 728.730 | 728.730 | 0 | 0 | P2P,SYS | - |
| `b0003` | `1n` | `223453Z-r01` | `small` | `b200_2rank_socket_4g` | `allgather` | `rank0=3,0,1,2;rank1=7,4,5,6` | `2rank_socket_4g` | 2 | 4 | `passed` | 633.200 | 633.200 | 0 | 0 | P2P,SYS | - |
| `b0003` | `1n` | `223453Z-r01` | `small` | `b200_2rank_socket_4g` | `reduce_scatter` | `rank0=3,0,1,2;rank1=7,4,5,6` | `2rank_socket_4g` | 2 | 4 | `passed` | 646.210 | 646.210 | 0 | 0 | P2P,SYS | - |
| `b0003` | `1n` | `223453Z-r01` | `small` | `b200_2rank_socket_4g` | `alltoall` | `rank0=3,0,1,2;rank1=7,4,5,6` | `2rank_socket_4g` | 2 | 4 | `passed` | 599.600 | 599.600 | 0 | 0 | P2P,SYS | - |
