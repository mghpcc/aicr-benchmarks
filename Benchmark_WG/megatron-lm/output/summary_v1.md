...
|-------------------|----------|-----------:|------------------------------------------------------------------------|
| out.a0004-9643    | rtx6000  |        2×1 | NCCL bootstrap timeout (`store->get('1')` wait timeout 600 000 ms)     |
| out.a0006-9644    | rtx6000  |        2×2 | NCCL bootstrap timeout                                                 |
| out.a0008-9645    | rtx6000  |        2×4 | NCCL bootstrap timeout                                                 |
| out.b0025-9651    | b200     |        2×1 | NCCL bootstrap timeout                                                 |
| out.b0027-9652    | b200     |        2×2 | NCCL bootstrap timeout                                                 |
| out.b0029-9653    | b200     |        2×4 | NCCL bootstrap timeout                                                 |
| out.b0025-9770    | b200     |          – | Job launch error: `global batch size must be passed as first argument` |

The six NCCL failures are all multi-node runs with **fewer than 8 GPUs/node**.
Multi-node runs that allocated **all 8 GPUs/node on each node succeeded** (a0010, b0007).
Failures stalled in the c10d/TCP key-value rendezvous stage *before* any NCCL traffic
left the node, so they are unrelated to InfiniBand health.
