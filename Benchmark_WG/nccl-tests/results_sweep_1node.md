...
![Converged bus bandwidth vs GPU count](sweep_1node_busbw.png)

*Converged 16 GB bus bandwidth vs GPU count (hypercube excluded). Generated by `plot_sweep_1node.py`.*
